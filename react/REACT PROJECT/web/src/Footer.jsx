        ...
        <div className="col-lg-8 col-md-12">
          <div className="row">
            ...
            <div className="col-md-4 mb-5">
              ...
              <div className="d-flex flex-column justify-content-start">
                <a className="text-secondary mb-2" href="#"><i className="fa fa-angle-right mr-2"></i>Profile</a>
                <a className="text-secondary mb-2" href="#"><i className="fa fa-angle-right mr-2"></i>Orders</a>
                <a className="text-secondary mb-2" href="#"><i className="fa fa-angle-right mr-2"></i>Settings</a>
                <a className="text-secondary mb-2" href="#"><i className="fa fa-angle-right mr-2"></i>Privacy Policy</a>
                <a className="text-secondary mb-2" href="#"><i className="fa fa-angle-right mr-2"></i>Logout</a>
              </div>
            </div>
            <div className="col-md-4 mb-5">
